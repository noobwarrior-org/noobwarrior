...
StaticJsonHandler::StaticJsonHandler(const std::string &jsonStr) : mJsonStr(jsonStr) {

}

void StaticJsonHandler::OnRequest(evhttp_request *req, void *userdata) {
    ...
    evbuffer_add_printf(reply, "%s", mJsonStr.c_str());
