...
// Description: Int64 property token.
#pragma once
...
class Int64Token : public IXmlPropertyToken {
public:
    std::string_view XmlPropertyToken() const override { return "int64"; }
    ...
    void WriteProperty(const Property &property, pugi::xml_node node) const override {
        if (const auto *value = property.CastValue<int64_t>())
